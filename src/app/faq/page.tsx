  ...
  return (
    <>
      ...
      <main className="bg-surface">
        {/* FAQ Hero Section */}
        <section className="relative px-margin-mobile md:px-margin-desktop pt-12 pb-16 max-w-container-max mx-auto">
          <div className="flex flex-col md:flex-row gap-8 items-end">
            <h1 className="font-display-xl text-display-xl uppercase text-on-background flex-1">
              Common <br /> <span className="text-primary-container">Questions</span>
            </h1>
            <div className="max-w-md md:text-right pb-4">
              <p className="font-label-caps text-label-caps text-on-surface-variant uppercase mb-2 tracking-[0.2em]">Engineered Permanence</p>
              <p className="font-body-lg text-body-lg text-on-surface">Clarifying our commitment to architectural excellence and high-end structural integrity.</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
            <aside className="lg:col-span-4 mb-8 lg:mb-0">
              <div className="sticky top-24">
                <h2 className="font-headline-lg text-headline-lg uppercase mb-4 leading-tight">Expertise <br /> & Logistics</h2>
                <p className="font-body-md text-body-md text-on-surface-variant max-w-xs">Our processes are as robust as our roofs. Explore our standard practices for luxury developments.</p>
              </div>
            </aside>
            <div className="lg:col-span-8 flex flex-col gap-0 border-t border-on-background/10">
              {[
                ...
                <details key={faq.id} className="group py-5 border-b border-on-background/10 cursor-pointer">
                  <summary className="flex justify-between items-center outline-none list-none [&::-webkit-details-marker]:hidden">
                    <div className="flex gap-6 items-center">
                      <span className="font-label-caps text-label-caps text-on-surface-variant opacity-40 uppercase">{faq.id}</span>
                      <h3 className="font-headline-lg text-headline-lg uppercase text-[24px] md:text-[32px] tracking-tight group-hover:text-primary-container transition-colors">
                        {faq.q}
                      </h3>
                    </div>
                    <span className="material-symbols-outlined text-3xl transition-transform duration-300 group-open:rotate-45">add</span>
                  </summary>
                  <div className="pt-4 pl-12 max-w-2xl">
        ...
        <section className="px-margin-mobile md:px-margin-desktop mb-16 max-w-container-max mx-auto">
          <div className="bg-on-background p-10 md:p-24 relative overflow-hidden flex flex-col items-center text-center">
            ...
            <h2 className="font-display-lg text-display-lg uppercase text-surface mb-6 relative z-10 leading-none">
              Still have <br /> <span className="text-primary-container">Questions?</span>
            </h2>
            <p className="font-body-lg text-body-lg text-surface-variant max-w-2xl mb-8 relative z-10">
              Our structural consultants are available for complex technical inquiries and global logistical coordination.
            </p>
            <Button variant="hero-cta" href="/contact" className="relative z-10">
