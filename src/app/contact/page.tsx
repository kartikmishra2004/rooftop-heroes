      ...
      <main>
        ...
        <section className="min-h-[85vh] flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 relative min-h-[400px] md:min-h-full overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 p-margin-mobile md:p-16 z-10">
              <h1 className="font-display-xl text-display-xl text-surface mb-6 leading-[0.9] uppercase">
                LET'S BUILD <br />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                <div>
                  <span className="font-label-caps text-label-caps text-surface/60 uppercase block mb-1">Office Headquarters</span>
                  <p className="font-body-md text-body-md text-surface text-sm">122 Industrial Way, Suite 400<br />Modern District, NY 10012</p>
                </div>
                <div>
                  <span className="font-label-caps text-label-caps text-surface/60 uppercase block mb-1">Direct Inquiry</span>
                  <p className="font-body-md text-body-md text-surface text-sm">+1 (555) 890-2344<br />hero@rooftopheroes.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Form Side */}
          <div className="w-full md:w-1/2 bg-surface px-margin-mobile md:px-20 py-16 flex flex-col justify-center">
            <div className="max-w-xl mx-auto w-full">
              <div className="mb-10">
                <span className="font-label-caps text-label-caps text-primary tracking-[0.2em] uppercase mb-3 block">New Projects</span>
                <h2 className="font-headline-lg text-headline-lg text-on-background leading-tight mb-4">Discuss your architectural vision with our engineering experts.</h2>
              </div>
        ...
        <section className="py-20 bg-on-background text-surface overflow-hidden">
          <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-end mb-16">
              <div className="md:col-span-8">
                <h3 className="font-display-lg text-display-lg text-headline-lg leading-none mb-6">GLOBAL <span className="text-primary-container italic">PRECISION.</span></h3>
                <p className="font-body-lg text-body-lg opacity-60 max-w-2xl">From modern skylines to coastal estates, our solutions are engineered to define the horizon.</p>
              </div>
              <div className="md:col-span-4 flex justify-end">
                <div className="text-right">
                  <span className="font-stats-num text-stats-num text-primary-container block">21</span>
                  <span className="font-label-caps text-label-caps uppercase tracking-widest opacity-60">Countries Served</span>
                </div>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="p-8 border border-surface/10 hover:border-primary-container transition-all group">
                  ...
                  <h4 className="font-headline-lg text-body-lg font-bold mb-3">{item.title}</h4>
                  <p className="font-body-md opacity-60 text-sm">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="h-[400px] w-full relative">
          ...
          <div className="relative z-10 h-full flex items-center justify-center pointer-events-none">
            <div className="bg-surface p-8 max-w-sm pointer-events-auto border-l-8 border-primary-container shadow-2xl">
              <span className="font-label-caps text-label-caps text-primary-container uppercase block mb-3">Main Studio</span>
              <h4 className="font-headline-lg text-headline-lg text-body-lg font-bold mb-4">Visit Our Gallery</h4>
              <p className="font-body-md text-body-md text-on-surface-variant mb-6 text-sm">Experience our materials and craftsmanship in person at our flagship architectural studio.</p>
              <button className="font-label-caps text-label-caps uppercase border-b-2 border-on-background pb-1 flex items-center gap-2 hover:text-primary-container hover:border-primary-container transition-all cursor-pointer">
