      ...
      <main className="relative flex-grow w-full flex items-center justify-center p-4">
        ...
        <section className="relative z-10 w-full max-w-[420px] mx-auto">
          <div className="text-center mb-4">
            ...
            <p className="font-body-md text-[13px] text-on-surface-variant opacity-70">Access your industrial dashboard.</p>
          </div>
          ...
          <div className="bg-surface p-6 border border-surface-variant/20 shadow-sm space-y-4">
            ...
            <div className="flex border-b border-surface-variant">
              <Link href="/auth/signin" className="flex-1 py-2 text-center font-label-caps text-[10px] border-b-2 border-on-background text-on-background transition-all cursor-pointer">SIGN IN</Link>
              <Link href="/auth/signup" className="flex-1 py-2 text-center font-label-caps text-[10px] border-b-2 border-transparent text-on-surface-variant opacity-50 hover:opacity-100 transition-all cursor-pointer">CREATE ACCOUNT</Link>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div className="group space-y-1">
                <label className="font-label-caps text-[9px] tracking-widest text-on-surface-variant opacity-60 uppercase transition-colors group-focus-within:text-primary-container">PASSWORD</label>
                <input 
                  className="w-full bg-transparent border-0 border-b border-surface-variant py-2 font-body-md text-on-background focus:ring-0 focus:border-primary-container placeholder:text-surface-variant/50 transition-all outline-none"
                  placeholder="••••••••" 
                  type="password" 
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input className="w-3 h-3 border-surface-variant text-on-background focus:ring-0 rounded-none bg-transparent cursor-pointer" type="checkbox" />
                  <span className="font-label-caps text-[9px] text-on-surface-variant opacity-70 group-hover:opacity-100 transition-opacity uppercase">Remember Me</span>
                </label>
                <Link className="font-label-caps text-[9px] text-on-surface-variant opacity-70 hover:opacity-100 hover:text-primary transition-all cursor-pointer" href="#">FORGOT?</Link>
              </div>
            ...
            <div className="relative flex items-center justify-center">
              <span className="absolute bg-surface px-2 font-label-caps text-[8px] text-surface-variant z-10 uppercase">OR CONTINUE WITH</span>
