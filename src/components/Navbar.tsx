...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky top-0 w-full bg-surface/90 backdrop-blur-md border-none" style={{ zIndex: 1001 }}>
        <nav className="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop py-4 max-w-container-max mx-auto relative z-[101]">
          <Link
            href="/"
            className="font-display-lg text-body-lg font-bold tracking-tighter text-on-background cursor-pointer z-[102]"
            onClick={() => setIsOpen(false)}
          >
            ROOFTOP HEROES
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="lg:hidden p-2 text-on-background focus:outline-none"
